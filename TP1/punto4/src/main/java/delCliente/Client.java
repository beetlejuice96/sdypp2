...
public class Client  {
    ...
    private static void borrarMensajes(){
        Mensaje mensajeBorrar = new Mensaje();
        mensajeBorrar.setDestino(JOptionPane.showInputDialog(null,"Destino para el cual se borraran los mensajes"));
        mensajeBorrar.setCuerpo(JOptionPane.showInputDialog(null,"Si verdaderamente quiere borrar escriba ok"));


        Gson gson = new Gson();
        String msj = gson.toJson(mensajeBorrar);
